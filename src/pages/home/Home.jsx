    ...
    return (
        <structure>
            ...
            <div className='clsGreentingAndWishesHome'>
                ...
                <div>
                    <h2 className='clsGreetingHome'>Good Morning Leon </h2>
            ...
            <article className='clsHomeTop' >
                ...
                <div className='clsHomeTopYogaAndMeditation'>
                    ...
                    <div>
                        <Link className='clsAnchorYoga' key={oneRandomYoga._id}>
                            <div className='clsDivLeftTopHomeYoga'>
                                ...
                                <p className='clsHomeParagraph1'>{oneRandomYoga.description}</p>
                                <p className='clsHomeParagraph2'>{oneRandomYoga.category}</p>
                    ...
                    <div>
                        <Link className='clsAnchorMeditation' key={oneRandomMeditation._id} to={`/meditationpage/${oneRandomMeditation._id}`}>
                            <div className='clsDivRightTopHomeMeditation'>
                                ...
                                <p className='clsHomeParagraph2'>{oneRandomMeditation.category}</p>
                    ...
                    <div className='clsRecommendedYogaItems'>
                        {
                            recommendedYogas.map(
                                (item) => {
                                    return (
                                        <Link key={item._id} className="clsRecommendedYogaProgramsLinks" >
