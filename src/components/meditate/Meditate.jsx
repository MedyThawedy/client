    ...
    return (
        <structure>
            ...
            <article className='clsArticleFrameSet'>
                <div></div>
                <div className='clsDivFrame'><iframe src="https://open.spotify.com/embed/track/7gKDK9GzPxHRLL4n6YDviC?utm_source=generator" width="82%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe></div>
                <div></div>
            </article>
