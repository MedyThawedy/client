...
const MeditateFavorites = () => {
    ...
    useEffect(
        () => {
            fetch(`${process.env.REACT_APP_BACKEND_URL}/api/findmeditationcategory?strmeditationcategory=Favourites`)
...
export default MeditateFavorites